...
I would like to thank members of Centre for Research on Cryptography and Security for a friendly environment with productive seasons and joyful procrastination topics. From those, I thank EACirc team members, who consulted and criticised the topics presented in this thesis. Especially I thank Petr for supervising me with his never-ending enthusiasm for science at all.
...
Most of all, I thank my parents, who always stand behind me. They always sensed the moments, when I need them and they surprised me with nice support. I am proud of having them.
}
...
\begin{itemize}
    \item Guided local search is always more successful than iterated local search and other methods. The single better result of simulated annealing does not mean it is better than guided local search, due to worse reference value because of the \textit{connection bug}.
...
\begin{itemize}
    ...
    \item Note: MD6 reduced to 10 rounds is still probably weak for TestU01 Crush and Rabbit. The results in the table were omitted due to consistency, as the interpretation method leaves them as passed test. However, the probability of those extreme results is below 1\,\%.
