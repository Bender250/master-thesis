...
\begin{description}
    ...
    \item[Dieharder] was developed by Robert G. Brown at the Duke University in 2004~\cite{brown2013dieharder}. It corrects some flaws of Diehard battery, extends it by many additional tests and also contains full NIST STS battery. However, it suffer similar flaws as NIST STS, as was detected by \todo{Lubo and Syso}. % fourth
    ...
    \item[Crypt-X suite] was a test battery for analysis of cryptoprimitives used in late nineties~\cite{cryptxs}. It was fully surpassed by NIST STS. % second
\end{description}
