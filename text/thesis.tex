...
The common application of ant colony optimization is in shortest path algorithms. Literature states many applications in traveling salesman problem~\cite{dorigo1997ant, dorigo1997ant}. However, the metaheuristic can be applied also in combinatorial problems, as the problem representation can be encoded to the graph structure and the shorted path algorithm may solve them. An example of such application can be formula satisfiability problem (SAT)~\cite{moritz2010solving}.
...
%   3. split the population in smaller sets
...
%   ANN developes decryption of basic boolean blocks of permutation and 'doping'
%   backprop, 3 layers (12-16-12), bits as -0.5, +0,5, linear activation
...
%   they are not cryptographers!!! Security by obscurity (key is the weight of connectors in the network), again bullshit (OMG, they even do not meet semantics security!)
