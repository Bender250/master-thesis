...
\begin{itemize}
    ...
    \item ANN can take advantage of bit-oriented evaluation, but we have not seen any benefits of it, even thou it is a crucial capability for cryptographic data
